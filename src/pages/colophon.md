...
- **Public keys** — The [/key](/key) page links to my public GPG and RSA keys, allowing visitors to verify signatures, encrypt messages, and confirm identity out-of-band.
