...
- **`rel="me"` links** — Profile links to [Mastodon](https://fosstodon.org/@alex), [my Forge](https://forge.l3x.in/alex), and [GitHub](https://github.com/shaftoe) include `rel="me"`, enabling [IndieAuth](https://indieauth.com/) identity verification and cross-site identity proof.
