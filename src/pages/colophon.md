...
- **Identity verification** — The [/keys](/keys) page links to my public GPG and SSH keys, allowing visitors to verify signatures, encrypt messages, and confirm identity out-of-band.
