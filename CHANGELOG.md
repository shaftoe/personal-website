...
- **usage**: add proper support for sub multi quota windows

## [1.35.1] - 2026-09-03

### Fixed

- **usage**: add support for custom currency
...
- **standard**: add missing atproto data

## [1.34.0] - 2026-07-20

### Added

- add automated read time length estimation
...
- adopt Standard.site lexicons for blog publishing (#416)
...
- rely only on PDS for atproto fetches (#408)
...
[unreleased]: https://github.com/shaftoe/personal-website/compare/v1.35.2...HEAD
[1.35.2]: https://github.com/shaftoe/personal-website/compare/v1.35.1...v1.35.2
[1.35.1]: https://github.com/shaftoe/personal-website/compare/v1.35.0...v1.35.1
